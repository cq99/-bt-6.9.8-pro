...
download_Url= https://raw.githubusercontent.com/cq99/bt-6.9.8-pro/master
...
if [[ "${faill}" == "1" ]]; then
    wget -O install.sh  https://raw.githubusercontent.com/cq99/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/install.sh && chmod 755 install.sh && bash install.sh install
	rm -rf install.sh
    main
elif [[ "${faill}" == "2" ]]; then
	main   
