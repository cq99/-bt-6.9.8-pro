...
{ 
	...
	Install_socket
	mkdir -p $pluginPath
	wget -O $pluginPath/firewalls_list.py https://raw.githubusercontent.com/cq99/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/firewalls_list.py -T 5
	...
	if [ "$pyVersion" == 2 ];then
		wget -O $pluginPath/btwaf_main.zip https://raw.githubusercontent.com/cq99/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/btwaf_main.zip -T 5
	...
	wget -O $pluginPath/info.json https://raw.githubusercontent.com/cq99/bt-6.9.8-pro/master/btwaf_rule/test/btwaf/info.json -T 5
...
Install_cjson()
{
	...
	if [ ! -f /usr/local/lib/lua/5.1/cjson.so ];then
		wget -O lua-cjson-2.1.0.tar.gz https://raw.githubusercontent.com/cq99/bt-6.9.6-pro/master/install/src/lua-cjson-2.1.0.tar.gz -T 20
...
{	
	...
	if [ ! -f /usr/local/lib/lua/5.1/socket/core.so ];then
		wget -O luasocket-master.zip https://raw.githubusercontent.com/cq99/bt-6.9.6-pro/master/install/src/luasocket-master.zip -T 20
